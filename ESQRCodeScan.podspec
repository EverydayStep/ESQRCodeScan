#
#  Be sure to run `pod spec lint ESQRCodeScan.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "ESQRCodeScan"
  s.version      = "0.0.1"
  s.summary      = "A QR Code Scan for iOS"
  ...
  s.source       = { :git => "https://github.com/EverydayStep/ESQRCodeScan.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "ESQRCodeScan/ESQRCodeScan/*.{h,m}"
